...
BEGIN
	...
	SELECT @MEDIA6MESES = dbo.Media6Meses(@ISIN)
	...
	ValorVariacao6Meses = @VALOR_VARIACAO6MESES, PercentagemVariacao6Meses = @VALOR_6MESES_PERCENTAGEM, Media6Meses = @MEDIA6MESES
	WHERE ISIN = @ISIN
